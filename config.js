...
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY DREAMKID-XMD🤍*",
...
DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ DREAMKID*",
ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/fgiecg.jpg",
LIVE_MSG: process.env.LIVE_MSG || "> DREAMKID*PK-XMD*⚡",
...
DEV: process.env.DEV || "254741749876",
